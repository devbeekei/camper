...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> HandlerExecutionChain(NoHandlerFoundException e) {
        final ApiResponse response = ApiResponse.error(ApiResponseType.NOT_FOUND);
    ...
    public ResponseEntity<ApiResponse> MethodArgumentNotValidException(HttpRequestMethodNotSupportedException e) {
        final ApiResponse response = ApiResponse.error(ApiResponseType.REQUEST_METHOD_NOT_SUPPORT);
    ...
    public ResponseEntity<ApiResponse> NotValidException(Exception e) {
        final ApiResponse response = ApiResponse.error(ApiResponseType.REQUEST_NOT_VALID);
    ...
    public ResponseEntity<ApiResponse> ConflictException(ConflictException e) {
        final ApiResponse response = ApiResponse.error(e.getApiResponseType());
